  ...
  data() {
    return {
      ...
      tableList: [
        ...
        { label: '用户昵称', rowName: 'LoginId' },
        { label: '登录账号', rowName: 'CoreCustNo' },
        { label: '上级', rowName: 'PartyNo' },
        { label: 'USDT余额', rowName: 'PartyName' },
        { label: '业务名称', rowName: 'BiName' },
        { label: '真实姓名', rowName: 'ProdCategory' },
        { label: '绑定账户', rowName: 'BiStateName' },
        { label: '注册时间', rowName: 'BiTime' },
        { label: '实名状态', rowName: 'BiChannel' }
      ],
      option: {
        placeholder: ' 请输入金额'
      }
